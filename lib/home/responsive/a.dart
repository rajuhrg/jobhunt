...
class ResponsiveGallery extends StatelessWidget {
   ResponsiveGallery({Key? key}) : super(key: key);
String image = "https://image.shutterstock.com/image-photo/young-woman-working-computer-600w-1187621914.jpg";
  @override
          ...
          ResponsiveRow(
            children: List.generate(100, (index) {
              return FlexWidget(
                ...
                child: Image.network(image),//"https://thispersondoesnotexist.com/image"),
